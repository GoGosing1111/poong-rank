...
EDIT_URL = "https://ygosu.com/board/soop/1648434/?mode=modify&backurl=https%3A%2F%2Fygosu.com%2Fboard%2Fsoop%2F1648434"

BASE_DIR = Path(__file__).resolve().parent
TXT_PATTERN = "ygosu_paste.txt"
        ...
        for el in driver.find_elements(By.CSS_SELECTOR, selector):
            try:
                if el.is_displayed() and el.is_enabled():
                    ...
                    js_set(driver, el, f"CNINE 통합 현황판 ({now} 갱신)")
                    print("제목 입력 완료")
                    return True
            except:
                pass
